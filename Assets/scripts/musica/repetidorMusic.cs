...
public class repetidorMusic : MonoBehaviour
{
    ...
    void Start()
    {
        _controlMusica=new controlMusica();    //contiene la variable estatica que indica si el sonido general esta muteado o no.
